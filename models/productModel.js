...
const productSchema = new mongoose.Schema({
    ...
    category: { type: String, required: true, enum: [
         "New Arrivals", "Gold Pendants", "Diamond Pendants",
         "Gold Earrings", "Diamond Earrings", "Diamond Rings", "Gold Rings", "Diamond Bangles", "Gold Bangles",
        "Diamond Mangalsutra", "Gold Mangalsutra", "Gold Chains", "Diamond Chains","Diamond Bracelets","Gold Bracelets","Diamond Necklace","Gold Necklace"
    ] },
